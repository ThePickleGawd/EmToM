#!/usr/bin/env python3
"""
Categorize tasks from the emtom task dataset using GPT-5.2.
...
Create 3-6 subcategories that group these tasks by their gameplay patterns or mechanics.
...
3. List which task numbers belong to this subcategory
