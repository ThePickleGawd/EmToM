...
Usage:
    ...
    ./emtom/bulk_monitor.sh outputs/emtom/bulk_gen_logs/2026-02-03_19-22-36-bulk-generate
"""
...
def find_latest_bulk_dir(project_root: Path):
    ...
    outputs_dir = project_root / "outputs" / "emtom" / "bulk_gen_logs"
...
def main():
    ...
    if args.log_dir:
        ...
        if log_dir is None:
            print(f"{RED}No bulk-generate output found in outputs/emtom/bulk_gen_logs/{NC}")
            sys.exit(1)
